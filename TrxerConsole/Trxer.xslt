...
>
  ...
  <msxsl:script language="C#" implements-prefix="trxreport">
    ...
    private string ToExtactTime(double ms)
    {
      ...
      if (ms >= 1000 && ms < 60000)
        return string.Format("{0:0.00} s", TimeSpan.FromMilliseconds(ms).TotalSeconds);
      ...
      <body>
        <div id="divToRefresh" class="wrapOverall">
            ...
            <table id="TotalTestsTable">
              ...
              <tbody>
                ...
                <tr id="DownloadSection">
                  <td>
                    <a href="#" class="button" id="btn-download" download="{/t:TestRun/@name}StatusesPie.png" style="font-size:10px;">Save graph</a>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <table id="ReportsTable">
                <Caption>
                  <h3>All Tests Group By Classes</h3>
            ...
            <thead>
              <tr class="oddcolor">
                ...
                <th scope="col" class="different" abbr="Test">
                  Classes <div class="NumberTag">
                    <xsl:value-of select="$classCount" />
                  </div>
                 <th scope="col"  class="different" abbr="Status">Status</th>
                </th>
                  <th scope="col"  class="different" abbr="Count">Total</th>
                  <th scope="col"  class="different" abbr="Count">Passed</th>
                  <th scope="col"  class="different" abbr="Count">Failed</th>
                  <th scope="col"  class="different" abbr="Count">Warning</th>            
                <th scope="col"  class="different" abbr="Exception">More</th>
              </tr>
            </thead>
            <tbody>
              <xsl:for-each select="$classSet">
                ...
                <tr>
                  ...
                  <td class="PackageStatus" style="width:50px;">
               
                  <div id="{generate-id(@className)}canvasPassed" style="height:1.5em;background-color:#76FF9F;float:left;"></div>
                    <div id="{generate-id(@className)}canvasFailed" style="height:1.5em;background-color:#ff5050;float:left;"></div>
                  </td>
                  ...
                  <td class="Count">
                       <span id="{generate-id(@className)}TestsContainerPassed"></span>
                  </td>
                  <td class="Count">
                      <span id="{generate-id(@className)}TestsContainerFailed"></span>
                  </td>
                  <td class="Count">
                      <span id="{generate-id(@className)}TestsContainerWarning"></span>
                   </td>
                  <td class="ex">
    ...
    <xsl:for-each select="/t:TestRun/t:Results/t:UnitTestResult[@testId=$testId]">
      <tr class="Test">
       <!-- <th scope="row" class="column1">
         ...
         <td class="Function">
          <!--<xsl:value-of select="@className" /> <xsl:value-of select="@testName" />-->
